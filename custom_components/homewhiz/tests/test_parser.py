...
delay_defined = bytearray.fromhex(
    "003853e0ab0100000000000000000000000000000000000000000300000000000000000a01280e000000008002100210002c000000000000000000010000000100000000000001078000000000"
)

delay_started = bytearray.fromhex(
    "003853e0ab0100000000000000000000000000000000000000000300000000000000003c01280e00000000800210021080ac080000000000000000010000000100000000000001078000808000"
)
